...
from PeculiarImageEncryption import views as mainView
...
urlpatterns = [
    ...
    path("UserShareImages/", usr.UserShareImages, name="UserShareImages"),
    path("UserViewImages/", usr.UserViewImages, name='UserViewImages'),
    path('getMessageFromImage/', usr.getMessageFromImage, name='getMessageFromImage'),
